...
public class ChangeWithoutBooleanNoteGUI extends JFrame {

	private JPanel contentPane;
	public ChangeWithoutBooleanNoteGUI() {
	...
	public void run(boolean x) {
		try {
			ChangeWithoutBooleanNoteGUI frame = new ChangeWithoutBooleanNoteGUI();
			frame.setVisible(true);
			if (x == true) {
				JLabel note = new JLabel("修改成功！");
