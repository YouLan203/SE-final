...
public class DeleteNote_MAGUI extends JFrame {

	private JPanel contentPane;
	public DeleteNote_MAGUI() {
	...
	public void run(boolean x) {
		try {
			DeleteNote_MAGUI frame = new DeleteNote_MAGUI();
			frame.setVisible(true);
			if (x == true) {
				JLabel note = new JLabel("刪除成功！");
